...
const ComplaintDetailsScreen = props => {
  ...
  const [compaintItem, setCompaintItem] = useState(
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubTitle}>#{compaintItem?.complaintId}</Text>
      </View>
      <View style={styles.footer}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.row}>
            <Text style={styles.contentTitle}>Subject:</Text>
            <Text style={styles.contentAnswer}>{compaintItem?.subject}</Text>
          </View>
          <View style={styles.viewSeperator} />

          <View style={styles.row}>
            <Text style={styles.contentTitle}>Category:</Text>
            <Text style={styles.contentAnswer}>{compaintItem?.category}</Text>
          </View>
          <View style={styles.viewSeperator} />
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.contentAnswer}>
              {compaintItem?.complaintLocation}
            </Text>
          </View>
          <View style={styles.viewSeperator} />
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.contentAnswer}>Pending</Text>
          </View>
          <View style={styles.viewSeperator} />

          {compaintItem?.photos.length > 1 && (
            <>
              <Text style={styles.contentTitle}>Photos:</Text>
              <View style={styles.photosView}>
                {compaintItem?.photos.map(item => {
